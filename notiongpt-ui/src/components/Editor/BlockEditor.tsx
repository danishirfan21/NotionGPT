...
import type { ParagraphElement } from '@/lib/utils';
    ...
    switch (element.type) {
      ...
      default:
        if (
          ...
          (element as ParagraphElement).generatedByAI
        ) {
          return (
            <p {...attributes} className="relative">
              {children}
              <span className="absolute -top-4 right-0 text-xs italic text-indigo-500">
                🧠 Generated by AI
              </span>
            </p>
          );
